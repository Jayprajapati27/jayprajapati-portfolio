            ...
            >
              ...
              <div className="order-1 lg:order-2 relative group">
                ...
                <div className="absolute -bottom-6 -right-6 flex gap-4">
                  <button className="w-14 h-14 rounded-full bg-white text-black flex items-center justify-center hover:bg-[#F27D26] hover:text-white transition-colors">
                    <Github className="w-6 h-6" />
                  </button>
                  <button className="w-14 h-14 rounded-full bg-[#F27D26] text-white flex items-center justify-center hover:bg-white hover:text-black transition-colors">

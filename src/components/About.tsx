  ...
  return (
    <section id="about" className="py-24 px-6 bg-[#050505] text-white">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-mono font-bold tracking-tighter uppercase mb-8">
        ...
        >
          ...
          <div className="absolute bottom-8 left-8">
            ...
            <h3 className="text-2xl font-bold">Bachelor of Computer Application</h3>
            <p className="text-white/50">Hemchandracharya North Gujarat University</p>
          </div>
        </motion.div>
      </div>
    </section>

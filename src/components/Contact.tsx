...
export default function Contact() {
  return (
    <footer id="contact" className="py-16 md:py-24 px-6 bg-[#050505] border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 mb-16 lg:mb-24">
          <div>
            <h2 className="text-5xl md:text-8xl font-mono font-bold tracking-tighter uppercase text-white mb-8 md:mb-12">
          ...
          <div className="flex flex-col justify-end gap-8">
            <a 
              ...
              className="group flex items-center justify-between p-6 md:p-8 bg-white/5 rounded-2xl border border-white/10 hover:border-[#F27D26] transition-all"
            >
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-base sm:text-lg md:text-xl font-bold text-white break-all">jayprajapati.tech05@email.com</p>
                </div>
              </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 md:gap-8 pt-12 border-t border-white/5 text-center md:text-left">
